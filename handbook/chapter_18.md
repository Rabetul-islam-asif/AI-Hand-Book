...
### Chapter Goal
এই চ্যাপ্টারের মূল লক্ষ্য হলো AI-এর সবচেয়ে বিপ্লবী ডোমেইন— মানে AI এজেন্টস (AI Agents) এবং Agentic Loop (Agentic Loop - Think → Act → Observe) এর Mechanism ক্র্যাক করা। তুমি জানতে পারবে কীভাবে চ্যাটবট থেকে রিয়েল ডিজিটাল এমপ্লয়ি বা Coding এজেন্ট তৈরি করা হয়, ReAct (Reasoning and Acting) Pattern কীভাবে মডেলকে কাজ করতে গাইড করে এবং প্ল্যানিং (Planning), রিফ্লেকশন (Reflection) ও সেলফ-কারেকশন প্রোডাকশন প্রজেক্টে কীভাবে Implement করতে হয়।

### Why Should I Care?
পুরনো ধাঁচের চ্যাটবটগুলো inactive থাকে; তুমি কোশ্চেন করলে তারা উত্তর দেয় এবং কাজ শেষ। কিন্তু **AI Agent** হলো স্বায়ত্তশাসিত (Autonomous) কর্মী। তুমি তাকে একটি লক্ষ্য বা গোল (Goal) দিয়ে ছেড়ে দেবে (যেমন: *"আমার এই Project-এর বাগ ফিক্স করে দাও"*), সে নিজেই পুরো কোডবেস রিড করবে, নিজেই প্ল্যান করবে, নিজেই Test রান করবে, ভুল হলে অটো-কারেক্ট করবে এবং প্রবলেম সলভ না হওয়া পর্যন্ত Loop চালিয়ে যাবে। Agentic Coding অ্যান্ড অটোমেশন এখন গ্লোবাল টেক ইন্ডাস্ট্রির এক নম্বর ট্রেন্ড।

### Big Picture
আগের চ্যাপ্টারগুলোতে আমরা AI টিউনিং এবং সেফটি এলাইনমেন্ট শিখেছি। এই চ্যাপ্টার থেকে আমাদের শুরু হচ্ছে **Agentic AI** এর রোমাঞ্চকর পার্ট। এখানে শেখা Agentic থিংকিং এবং ReAct Loop আমাদের পরের chapter-এর টুল কলিং (Tool Calling), Custom এমসিপি (MCP) প্রোটোকল এবং প্রোডাকশন অবজারভেবিলিটি ও হারনেস Engineerিং বোঝার মূল ভিত্তি।
