...
AI এজেন্ট হলো এই দায়িত্বশীল কর্মী। সে কেবল ওয়ার্ড প্রেডিক্ট করে না; সে নিজের কাজের ফলাফল ট্র্যাক করে Loop চালিয়ে গোল এচিভ করে।

---

### ২. Core Concepts: এজেন্টিক Loop ও রিঅ্যাক্ট Pattern

একটি কাস্টম AI এজেন্ট মূলত ৪টি প্রধান উপাদানের সমন্বয়ে গঠিত:
...
* **Thought (চিন্তা):** AI প্রথমে এনালাইসিস করে: *"এই মুহূর্তে আমার কাস্টমারের ট্রানজ্যাকশন আইডি ও স্ট্যাটাস জানা প্রয়োজন।"*
...
#### ঘ. Tools (অস্ত্রাগার)
এজেন্টের হাত-পা। AI নিজে ব্রাউজার বা Database এক্সেস করতে পারে না। আমরা তাকে API, CLI, বা Bash কমান্ড রান করার কাস্টম Function বা টুল জোড়া দিয়ে দেই।
...
এজেন্টিক AI প্রোডাকশনে ডিপ্লয় করার সময় সবচেয়ে বিপজ্জনক বিপদ হলো **Infinite Loop / VRAM Blow-up**।
...
### ৯. Mini Project: পাইথনে স্ক্র্যাচ থেকে একটি কাস্টম File এডিটিং AI এজেন্ট উইথ ব্যাকট্র্যাকিং
...
* **When to use:** কাস্টম Coding অ্যাসিস্ট্যান্ট এবং সেলফ-কারেক্টিং AI অটোমেশন এজেন্ট আর্কিটেক্ট করার জন্য।
...
1. **প্রশ্ন:** সাধারণ চ্যাটবট এবং AI এজেন্টের (AI Agent) মধ্যে মূল বৈসাদৃশ্য কী?
   * **উত্তর:** চ্যাটবট শুধুমাত্র মেসেজ ফ্লোতে ইউজারের প্রশ্নের ওয়ান-শট উত্তর দেয় এবং কাজ শেষ। কিন্তু AI এজেন্ট স্বায়ত্তশাসিতভাবে একটি গোল পাওয়ার পর নিজে চিন্তা (Think), কাজ (Act), এবং পর্যবেক্ষণ (Observe) Loop চালিয়ে ভুল নিজে সংশোধন করে লক্ষ্য অর্জন না হওয়া পর্যন্ত কাজ চালিয়ে যায়।

#### Intermediate
2. **প্রশ্ন:** এজেন্টিক AI-তে "ReAct" ডিজাইন Pattern কীভাবে কাজ করে?
...
### ১২. What's Next
দারুণ! আমরা সফলভাবে AI এজেন্টের কোর ফাউন্ডেশন ও সেলফ-কারেকশন Loop জয় করে ফেলেছি। পরবর্তী চ্যাপ্টারে আমরা এই এজেন্টের সবচেয়ে গুরুত্বপূর্ণ হাত-পা বা অ্যাকশন লেয়ার নিয়ে আলোচনা করব: **Chapter 19: Tool Calling & Function Integration**। কীভাবে JSON স্কিমা ব্যবহার করে টুল কনট্র্যাক্ট ডিজাইন করা হয় এবং AI কীভাবে ডায়নামিকালি সঠিক Parameter জেনারেট করে কাস্টম API কল করে, তা আমরা বিস্তারিত শিখব।
