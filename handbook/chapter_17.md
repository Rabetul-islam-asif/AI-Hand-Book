...
### Chapter Goal
এই চ্যাপ্টারের মূল লক্ষ্য হলো লার্জ Language মডেলকে মানুষের নৈতিকতা, উপযোগিতা এবং নিরাপত্তার সাথে সারিবদ্ধ বা এলাইন করার ব্যাকবোন Mechanism— মানে এলাইনমেন্ট (Alignment), RLHF (Reinforcement Learning from Human Feedback) এবং আধুনিক DPO (Direct Preference Optimization) এর কোর Math-এর ও ফিলোসফিক্যাল Intuition সলভ করা। তুমি জানতে পারবে কীভাবে AI-কে ক্ষতিকর কথা বলা থেকে আটকানো হয়, Reward Model (Reward Model) কীভাবে মডেলে মানুষের ভালোলাগা-মন্দলাগা Simulate করে এবং PPO Algorithm-এর জটিল এয়ারপোর্ট এড়িয়ে কীভাবে DPO ডিরেক্টলি সিঙ্গেল-স্টেপ লুপে মডেলকে প্রেফারেন্স লার্নিং শেখায়।

### Why Should I Care?
একটি সাধারণ এলএলএম Fine-Tuning করার পরেও সে খুব বিপজ্জনক বা সাইবার ক্রাইম সহায়ক প্রশ্নের উত্তর দিয়ে দিতে পারে (যেমন: `"কীভাবে বোমা বানাব?"`)। তুমি যদি প্রজেক্টে AI-এর সেফটি এলাইনমেন্ট এবং গার্ডরেইল টিউনিং নিশ্চিত না করো, তবে প্রোডাকশনে রিলিজ করার সাথে সাথেই তোমার AI প্রডাক্ট হ্যাকারদের Prompt ইনজেকশনের শিকার হয়ে Companyর লিগ্যাল এবং রেপুটেশনাল Image ধ্বংস করে দেবে। AI সেফটি Architect হওয়া বর্তমান গ্লোবাল মার্কেটের সবচেয়ে হাই-Valueয়ড পজিশন।

### Big Picture
আগের চ্যাপ্টারে আমরা LoRA/QLoRA GPU অপ্টিমাইজেশন ব্যবহার করে কীভাবে Custom Fine-Tuning সম্পন্ন করতে হয় তা শিখেছি। এই চ্যাপ্টারে আমরা সেই ফাইন-টিউনড মডেলকে একটি কড়া **Safety Grid** এর ভেতর লক করে তাকে "ভদ্র ও সমাজ-অনুমোদিত কর্মী"-তে convert করব। এটি আমাদের পরের chapter-এর Agentic AI (Agentic AI - Tool calling, MCP) এবং বাস্তব প্রোডাকশন Architecture দাঁড় করানোর final সোপান।
