...
একটি সিঙ্গেল ইউজার মেসেজ সলভ করতে AI এজেন্ট ভেতরের লেয়ারে হয়তো ৫টি API কল এবং ৩টি লোকাল টুল রান করেছে। ট্রেসিং এই পুরো সিকোয়েন্সকে একটি প্যারেন্ট-চাইল্ড হাইয়ার্কি **Tree (স্প্যান - Spans)** হিসেবে রেকর্ড করে।
...
1. **প্রশ্ন:** প্রথাগত লিনিয়ার লগার File-এর (যেমন: Winston/console.log) তুলনায় ডিস্ট্রিবিউটেড ট্রেসিং (Tracing) কেন AI এজেন্টের জন্য আবশ্যক?
   * **উত্তর:** প্রথাগত লগার শুধুমাত্র ফ্ল্যাট টাইমস্ট্যাম্পে সিঙ্গেল লাইন Log লেখে। কিন্তু AI এজেন্ট এক ইউজার রিকোয়েস্টে ভেতরের লেয়ারে মাল্টি-স্টেপ কম্পিউটেশন (Embedding, Vector Search, Tool calls) রান করে। ট্রেসিং এই পুরো প্রসেসকে একটি প্যারেন্ট-চাইল্ড গ্রাফ Tree হিসেবে Latency, কস্ট ও Input-আউটপুটসহ ভিজ্যুয়ালাইজ করতে পারে, যা ডিবাগিংয়ের জন্য অপরিহার্য।
...
#### Advanced
3. **প্রশ্ন:** প্রোডাকশন গেটওয়েতে AI অবজারভেবিলিটি মনিটর করার সময় PII Leakage বা Data সিকিউরিটি লিক প্রতিহত করার স্ট্যান্ডার্ড আর্কিটেকচারাল Pattern কী?
