...
```
ইউজার যখন কোড রান করতে যান, স্ক্রিনে বড় লাল এরর আসে: `ModuleNotFoundError: No module named 'request'`। ইউজারকে আবার সেই এরর কপি করে এআই-তে পেস্ট করতে হয়। এই অনবরত কপি-পেস্ট করা ডেভেলপারের মূল্যবান সময় নষ্ট করে।
...
চলুন পাইথনে একটি সম্পূর্ণ রানিং, কাস্টম সেলফ-হিলিং এজেন্ট লুপ স্ক্র্যাচ থেকে ডিজাইন করি যা ফেইলড পাইথন টেস্টকে নিজে নিজেই হিল বা রিসলভ করবে।
...
def run_self_healing_agent():
    ...
    for iteration in range(1, max_iterations + 1):
        ...
        # মার্কডাউন কোড ব্লক ট্রিম করুন যদি এলএলএম ভুল করে দিয়ে দেয়
        ...
        if test_passed:
            ...
            # এরর লগটি কনভারসেশন হিস্টোরিতে ফিড করুন অটো-হিলিংয়ের জন্য
            feedback = f"""
...
প্রোডাকশন লেভেলে যখন আপনি গ্রাহকদের জন্য কোড এডিটিং সিস্টেম ডেপ্লয় করবেন, তখন আপনাকে নিচের কড়া সিকিউরিটি আর্কিটেকচার মেনে চলতে হবে:

* **Resource Limiting (কম্পিউট লকিং):** কোনো হ্যাকার যদি প্রম্পটে একটি ইনফিনিটি লুপ কোড লিখে আপনার সার্ভারে টেস্ট রান করায়, তবে আপনার সিপিইউ ক্র্যাশ করবে। তাই প্রতিটি সাব-প্রসেস এক্সিকিউশনে অবশ্যই `timeout=10.0` প্যারামিটার ব্যবহার করতে হবে যাতে ১০ সেকেন্ডের বেশি কোনো স্ক্রিপ্ট চললে তা সাথে সাথে কিল হয়ে যায়।
...
চলুন পাইথনে কোড করে প্র্যাক্টিক্যালি দেখি কীভাবে কোনো কমান্ড বা এআই স্ক্রিপ্ট ইনফিনিটি লুপে আটকে গেলে তাকে টাইমার দিয়ে কিল করতে হয়।
...
#### Advanced
3. **প্রশ্ন:** প্রোডাকশনে Devin বা Cursor-এর মতো কোড জেনারেটর এজেন্ট ডিজাইনে "Docker Sandbox Container" এর প্রয়োজনীয়তা গাণিতিক ও আর্কিটেকচারাল দিক থেকে ব্যাখ্যা করুন।
   * **উত্তর:** এআই বা ম্যালিসিয়াস প্রম্পট যদি লোকাল ওএসে সরাসরি অ্যাক্সেস পায়, সে আপনার কম্পিউটারের সব পার্সোনাল ফাইল রিড করতে পারে বা ক্ষতিকর কমান্ড রান করে ডাটাবেস মুছে দিতে পারে। ডকার স্যান্ডবক্স কন্টেইনার একটি আলাদা লাইটওয়েট ভার্চুয়াল ফাইলসিস্টেম তৈরি করে যার সাথে লোকাল ওএসের কোনো মেমোরি বা নেটওয়ার্ক শেয়ার থাকে না। ফলে এজেন্ট ডকারের ভেতরে কোনো ক্ষতি করলেও কন্টেইনারটি বন্ধ করার সাথে সাথে ডাটাবেস ও সিস্টেম রিবুট হয়ে ফ্রেশ স্টেটে ফিরে আসে, যা লোকাল ওএসকে ১০০% সিকিউর রাখে।
