...
### Chapter Goal
এই চ্যাপ্টারের মূল লক্ষ্য হলো সাধারণ আরএজি (RAG) পাইপলাইনের এক্যুরেসি ৯০% থেকে ৯৯% এ উন্নীত করার জন্য সবচেয়ে শক্তিশালী প্রোডাকশন মেকানিজম—অর্থাৎ অ্যাডভান্সড রিট্রিভাল (Advanced Retrieval), হাইব্রিড সার্চ (Hybrid Search - BM25 + Dense Vector), এবং রির‍্যাঙ্কিং (Re-ranking) এর আর্কিটেকচারাল মেকানিজম ক্র্যাক করা। তুমি জানতে পারবে কীভাবে প্যারেন্ট-ডকুমেন্ট রিট্রিভাল (Parent-Document Retrieval) এবং HyDE (Hypothetical Document Embeddings) কাজ করে এবং প্রোডাকশন প্রজেক্টে এগুলোর নিখুঁত সিলেকশন ও ইমপ্লিমেন্টেশন ক্রাইটেরিয়া আয়ত্ত করতে পারবে।
...
* **Basic RAG (বেসিক ভেক্টর সার্চ):** লাইব্রেরিয়ান বই ঘেঁটে ১টি নির্দিষ্ট প্যারাগ্রাফ খুঁজে পেলে যা তোমার কোশ্চেনের সাথে ম্যাচ করে। কিন্তু সমস্যা হলো, সেই প্যারাগ্রাফের ভেতর লেখা আছে: *"অনুচ্ছেদ ৪ এর নিয়ম অনুসারে এটি লক হবে।"* এখন অনুচ্ছেদ ৪ কী? লাইব্রেরিয়ান তা জানো না! ফলে এআই মডেলটি ইনকমপ্লিট বা বিভ্রান্তিকর উত্তর দেবে।
...
* **Parent-Document Retrieval:** লাইব্রেরিয়ান ভেক্টর সার্চের মাধ্যমে ছোট চাঙ্কটি খুঁজে পেলে, কিন্তু প্রম্পটে পাঠানোর আগে তিনি সেই ছোট চাঙ্কের মূল উৎস বা পুরো "অনুচ্ছেদ ৪"-এর ৪টি প্যারাগ্রাফ একসাথে টেনে আনলেন (Parent Document)। এর ফলে এআই মডেল পুরো ব্যাকগ্রাউন্ড জেনে নিখুঁত উত্তর দেবে।
...
2. **First-Stage Retrieval:** তোমার কুয়্যারির ওপর স্পার্স ও ডেন্স হাইব্রিড সার্চ রান করে ফার্স্ট স্টেজে ১০০টি সম্ভাব্য সোর্স পেজ তুলে আনা হয়।
...
# ৪. রির‍্যাঙ্কড আউটপুট প্রিন্ট করো
...
চলো পাইথনে কাস্টম NumPy ব্যবহার করে কোনো লাইব্রেরি ছাড়া একটি পূর্ণাঙ্গ মিনি হাইব্রিড সার্চ এগ্রিগেটর এবং রির‍্যাঙ্কিং স্কোরার সিস্টেম স্ক্র্যাচ থেকে আর্কিটেক্ট করি।
