...
একটু ভাবো তো— তোমার AI Model দুনিয়ার সব থিওরি জানে, কিন্তু সে কি তোমার Database পড়তে পারে? পারে না। আজকের আবহাওয়া জানে? জানে না। bKash-এর ট্রানজ্যাকশন চেক করতে পারে? পারে না। কারণ সে সম্পূর্ণ অন্ধ। তার কোনো হাত-পা নেই।

তার হাত-পা দেওয়ার নামই হলো Tool Calling। তুমি JSON Schema দিয়ে একটা কনট্র্যাক্ট বানাবে— AI সেটা পড়ে বুঝবে কোন Function কল করতে হবে, কী Parameter দিতে হবে। তারপর তোমার ব্যাকএন্ড Code সেটা এক্সেকিউট করবে। মনে রেখো— AI নিজে কোনো API কল করে না। সে শুধু ডিসিশন মেকার, এক্সেকিউটর তোমার Code।

তো চলো দেখি কীভাবে JSON Schema কনট্র্যাক্ট ডিজাইন করতে হয়, Tool Calling Loop-এর ৪টা ধাপ কী কী, আর Parallel টুল কলিং কীভাবে হ্যান্ডেল করতে হয়। এটা শিখলে পরের চ্যাপ্টারের MCP Protocol বুঝতে কোনো ঝামেলাই হবে না।
