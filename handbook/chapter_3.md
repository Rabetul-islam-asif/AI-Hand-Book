...
### Chapter Goal
এই চ্যাপ্টারের মূল লক্ষ্য হলো AI-এর লার্নিং বা Optimization-এর Math সহজ করে ভাঙা। আমরা Mathematical Calculus বা কঠিন ফর্মুলার ফাঁদে না পড়ে সহজ ভাষায় real-life example দিয়ে Loss Function (Loss Functions - যেমন: MSE, Cross-Entropy), গ্র্যাডিয়েন্ট ডিসেন্ট (Gradient Descent) এবং Learning Rate (Learning Rate) এর Math-এর Intuition বা ভেতরের Mechanism সহজে বুঝবো।

### Why Should I Care?
Model Training-এর সময় যখন তুমি Loss গ্রাফে দেখেন Loss কমছে না বা হুট করে ইনফিনিটি হয়ে যাচ্ছে (Exploding Gradients), তখন যদি পেছনের গণিত তোমার জানা না থাকে, তবে তুমি Prompt চেঞ্জ করে বা র্যান্ডমলি Parameter ঘুরিয়ে কোনোদিনও প্রবলেম সলভ করতে পারবে না। একজন Professional AI Engineer হতে গেলে Loss কার্ভ Analysis এবং Optimization Loop Debug করার স্কিল থাকতেই হবে।

### Big Picture
আমরা আগের চ্যাপ্টারে মেশিন ও Deep Learning-এর ভেতরের Mechanics এবং বিভিন্ন লার্নিং টাইপের পরিচয় পেয়েছি। এই চ্যাপ্টারটি আমাদের হ্যান্ডবুকের সবচেয়ে গুরুত্বপূর্ণ Math foundation, কারণ এর পর থেকে আমরা যখনই কোনো নেটওয়ার্ক ট্রেইন করবো (যেমন Fine-Tuning বা আরএলএইচএফ), এই গ্র্যাডিয়েন্ট ডিসেন্ট থিওরিটাই বারবার ফিরে আসবে।
...
তুমি কীভাবে নামবে?
তুমি তোমার পায়ের নিচের দিক দিয়ে মাটির ঢাল (Slope) অনুভব করার চেষ্টা করবে। মাটির যেদিকটা সবচেয়ে বেশি নিচের দিকে নেমে গেছে, তুমি carefully সেদিকে এক পা বাড়াবেন। তারপর আবার ঢাল মাপবেন, আবার পা বাড়াবেন। এভাবে প্রতিটি ধাপে ঢাল অনুসরণ করে একসময় তুমি পাহাড়ের lowest point-এ পৌঁছে যাবে।

AI পরিভাষায়:
* **পাহাড়ের চূড়া:** Model-এর ভুল বা সর্বোচ্চ Loss (High Loss)।
* **পাহাড়ের lowest valley:** Model-এর perfect Parameter বা সর্বনিম্ন Loss (Minimum Loss)।
...
* **খুব ছোট Learning Rate (Too Small):** Model খুব ধীর গতিতে শিখবে। পাহাড় থেকে নামতে যদি পিঁপড়ার মতো পা ফেলেন, তবে চূড়া থেকে নিচে নামতে কয়েক মাস লেগে যাবে।
* **খুব বড় Learning Rate (Too Large):** Model-এর Loss কার্ভ লাফালাফি করতে থাকবে (Diverge)। পা ফেলার সাইজ যদি পাহাড়ের সমান হয়, তবে তুমি এক পাহাড় থেকে লাফ দিয়ে পাশের পাহাড়ে চলে যাবে, কোনোদিনও নিচু valleyয় পৌঁছাতে পারবে না।
