...
* **Stripe Usage Event:** প্রতিবার এআই Response শেষ হলে ব্যাকগ্রাউন্ডে স্ট্রাইপে একটি ইভেন্ট পুশ করা হয়: `stripe.SubscriptionItem.create_usage_record(subscription_item_id, quantity=1500, timestamp=now)`।
...
Midjourney বা রানওয়ে এআই-তে সাবস্ক্রাইব করার পর:
* তুমি পান ২৫টি ফাস্ট ক্রেডিট। তুমি জেনারেশন অন করলে ক্রেডিট Loss হিসেব হয় এবং ফাস্ট ক্রেডিট জিরো হয়ে গেলে এআই তোমাকে স্লো লাইনে ফেলে দেয়।
...
চলো পাইথনে একটি রানিং, প্রোডাকশন-গ্রেড এআই সেস (AI SaaS) ব্যাকঅ্যান্ড লজিক ডিজাইন করি যা একই সাথে Redis দিয়ে TPM/RPM চেক করবে এবং Token ইউসেজ সরাসরি স্ট্রাইপ এপিআইতে পুশ করবে।
...
প্রোডাকশনে যখন তুমি বড় স্কেলে এআই সেস Deploy করবে, তখন তোমাকে নিচের ক্যাশ ডিজাইন গাইডলাইন মেনে চলতে হবে:
...
1. **প্রশ্ন:** প্রথাগত সফটওয়্যারের চেয়ে এআই সেস (AI SaaS)-এ রেট লিমিটিং কেন ভিন্নভাবে ডিজাইন করতে হয়?
   * **উত্তর:** প্রথাগত সফটওয়্যারে শুধু রিকোয়েস্ট কাউন্ট (RPM) করলেই চলে। কিন্তু এআই-তে প্রতিটি রিকোয়েস্টের Context সাইজ ভিন্ন হওয়ায় Token ব্যবহারের মান অনেক ওঠানামা করে। তাই কস্টিং কন্ট্রোল করতে RPM এর পাশাপাশি Token পার মিনিট (TPM) রেট লিমিটিং ডিজাইন করা অত্যন্ত আবশ্যিক।
