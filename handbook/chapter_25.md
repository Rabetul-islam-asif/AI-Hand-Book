...
চলো একটি রিয়েল-ওয়ার্ল্ড কোম্পানির পলিসি ডকুমেন্টের উদাহরণ দেখি:
...
* **কেন এটি সেরা প্রোডাকশন চয়েস:** কারণ তোমাকে আলাদা করে কোনো নতুন ভেক্টর ডাটাবেস (যেমন Pinecone বা Chroma) হোস্ট করতে হয় না। তোমার রিলেশনাল ইউজারের ডাটা এবং তাদের ডকুমেন্টের ভেক্টর ডাটা একই Postgres ডাটাবেসে অত্যন্ত সুরক্ষিত থাকে এবং তুমি মেটাডাটা দিয়ে ফাস্ট SQL কুয়েরি চালাতে পারো।
...
HNSW ইনডেক্স কীভাবে কাজ করে তার আর্কিটেকচার জ্যামিতিক গ্রাফে দেখে নাও:
...
* **ভুল চাঙ্কিং:** অফিসার কুয়েরি করলে: *"৬০ বছর বয়সীদের লোন পলিসি কী?"* চাঙ্ক মাঝখান থেকে কেটে যাওয়ায় সিস্টেম লোন সুদের মান ১% খুঁজে পেলো, কিন্তু নোটারি বন্ডের ইনফরমেশন ফিল্টার আউট হয়ে গেল।
...
চলো পাইথনে কোড করে একটি রিয়েল-ওয়ার্ল্ড পিডিএফ সেমান্টিক চাঙ্কিং লুপ এবং pgvector ইনডেক্সিং ডেপ্লয় করার সম্পূর্ণ সোর্স কোড আর্কিটেক্ট করি।
...
* **RAM vs. Vector Storage:** HNSW ইনডেক্সিংয়ের ক্ষেত্রে পুরো গ্রাফ নেটওয়ার্কটি র‍্যামের (RAM) ওপর স্টোর হয়ে কম্পিউটেশন রান করে। তাই তোমার ডাটাবেস সার্ভারের র‍্যাম সাইজ অবশ্যই ইনডেক্স করা টোটাল ভেক্টরের মেমোরি সাইজের চেয়ে ১.৫ গুণ বেশি হতে হবে।
...
**"আগের ক্যারেক্টার চাঙ্কিং হলো অন্ধের মতো কুড়াল দিয়ে পেপার কাটা, যা বাক্যের মাঝখান থেকেও টুকরো করে ফেলে। আর সেমান্টিক চাঙ্কিং হলো সুনিপুণ কাঁচি, যা কেবল প্যারাগ্রাফ বা বাক্য শেষ হওয়ার অর্থপূর্ণ সন্ধিক্ষণেই ফোল্ডিং কাটে।"**

---

### IX. Mini Project: স্ক্র্যাচ Cosine Similarity ডিস্ট্যান্স ক্যালকুলেটর

চলো NumPy ব্যবহার করে দুটি এম্বেডিংস ভেক্টরের মধ্যকার জ্যামিতিক দূরত্ব ও কোসাইন সিমিলারিটি স্ক্র্যাচ থেকে ক্যালকুলেট করি, যা pgvector ব্যাকগ্রাউন্ডে রান করে।
