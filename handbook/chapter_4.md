...
### Chapter Goal
এই চ্যাপ্টারের মূল লক্ষ্য হলো Machine Learning ও ডিপ লার্নিংয়ের সবচেয়ে বড় ট্র্যাজেডি—অর্থাৎ Model-এর মুখস্থ করার প্রবণতা বা ওভারফিটিং (Overfitting) এবং কিছুই না শেখার অলসতা বা আন্ডারফিটিং (Underfitting) Mechanism চমৎকারভাবে বোঝা। আমরা জানবো Bias-ভ্যারিয়েন্স ট্রেডঅফ (Bias-Variance Tradeoff), ড্রপআউট (Dropout), এবং আর্লি স্টপিং (Early Stopping) এর মতো প্রোডাকশন-গ্রেড রেগুলারাইজেশন ট্যাকটিকস কীভাবে কাজ করে।
...
* **কনসেপ্ট:** ডিপ লার্নিংয়ের প্রতিটি Training পদক্ষেপে র্যান্ডমলি কিছু নিউরনকে সাময়িকভাবে "অফ" বা ডিঅ্যাক্টিভেট করে দেওয়া হয় (যেমন ২০% নিউরন)।
...
কিন্তু নেটফ্লিক্সের জেনারেলাইজড Model জানে যে মানুষ ভুল ক্লিক করতে পারে (Noise)। সে ড্রপআউট ও Bias কন্ট্রোল করে তোমার দীর্ঘদিনের দেখার অভ্যাস অ্যানালাইসিস করে একটি ব্যালেন্সড রিকমেন্ডেশন ফিড জেনারেট করে।
