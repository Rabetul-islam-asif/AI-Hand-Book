...
### Chapter Goal
এই চ্যাপ্টারের মূল লক্ষ্য হলো Machine Learning ও Deep Learning-এর সবচেয়ে বড় ট্র্যাজেডি— মানে Model-এর মুখস্থ করার প্রবণতা বা Overfitting (Overfitting) এবং কিছুই না শেখার অলসতা বা Underfitting (Underfitting) Mechanism সুন্দরভাবে বোঝা। আমরা জানবো Bias-ভ্যারিয়েন্স ট্রেডঅফ (Bias-Variance Tradeoff), ড্রপআউট (Dropout), এবং আর্লি স্টপিং (Early Stopping) এর মতো প্রোডাকশন-গ্রেড Regularization ট্যাকটিকস কীভাবে কাজ করে।

### Why Should I Care?
Developer হিসেবে তুমি একটি মডেলকে ৯৯% Training এক্যুরেসিতে ট্রেইন করে খুব খুশি হতে পারো। কিন্তু যখন সেটি রিয়েল Customারের সামনে প্রোডাকশনে লঞ্চ করবে, তখন দেখা গেল তার এক্যুরেসি নেমে গেছে মাত্র ২০%। এই বিপর্যয়কে এড়াতে এবং তোমার Model যেন শুধুমাত্র Training Data মুখস্থ না করে নতুন বাস্তব পরিস্থিতি বুঝতে পারে (Generalization), তার সমাধান এই চ্যাপ্টারে বিশদভাবে আলোচনা করা হয়েছে।

### Big Picture
আমরা আগের চ্যাপ্টারে Loss Function ও গ্র্যাডিয়েন্ট ডিসেন্টের মাধ্যমে মডেলকে Optimize করা শিখেছি। এই চ্যাপ্টারে আমরা শিখবো কীভাবে সেই Optimization লুপকে কন্ট্রোল করতে হয়, যাতে Model অতিরিক্ত Optimized হয়ে Overfit না হয়।
