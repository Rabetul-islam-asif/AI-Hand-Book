...
### Chapter Goal
এই চ্যাপ্টারের মূল লক্ষ্য হলো Deep Learning-এর সবচেয়ে ছোট building block — মানে আর্টিফিশিয়াল নিউরন বা Perceptron এর anatomy পুরোপুরি বোঝা। আমরা বিস্তারিত শিখবো কীভাবে Input Feature-এর সাথে Weight ও Bias গুণ হয়ে নির্দিষ্ট Activation Function-এর (Activation Functions - যেমন: Sigmoid, ReLU, tanh, Softmax) মাধ্যমে Non-linear ডিসিশন মেকিং সম্পন্ন হয়।

### Why Should I Care?
Deep Learning-এর সব বড় বড় Architecture (যেমন সিএনএন, আরএনএন বা Transformers) আসলে কোটি কোটি কৃত্রিম নিউরনের এক বিশাল পরিবার ছাড়া আর কিছুই নয়। Activation Function কীভাবে সিলেক্ট করতে হয় তা না জানলে তোমার Model-এর ভেতর দিয়ে সিগন্যাল পাস হবে না (Dead ReLU বা Vanishing Gradient রোগ)। Developer হিসেবে নিউরনের ভেতরের Data ফ্লো ও Activation চয়েস জানা তাই খুব জরুরি।

### Big Picture
আমরা আগের পার্টগুলোতে Machine Learning ও জেনারেল Generalization-এর ভিত্তি শেষ করেছি। এই চ্যাপ্টার থেকে আমাদের প্রবেশ ঘটছে **Part 3 — Deep Learning & Neural Networks** এর চমৎকার Deep Learning world-এ। পরের chapter-এ আমরা এই একক নিউরনগুলোকে একসাথে জুড়ে দিয়ে গভীর Neural Network দাঁড় করাবো।
