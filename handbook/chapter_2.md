...
* **২. Validation Set (১০% - ১৫% Data):** এটি হলো পরীক্ষার আগের দিন দেওয়া **মক টেস্ট (Mock Test)** বা সেলফ-অ্যাসেসমেন্ট পরীক্ষা। এই টেস্টের রেজাল্ট দেখে তুমি বুঝতে পারো তোমার কোন চ্যাপ্টারে দুর্বলতা আছে এবং সেই অনুযায়ী পড়ার অভ্যাস (Hyperparameters, যেমন: Learning Rate বা Depth) পরিবর্তন করো।
