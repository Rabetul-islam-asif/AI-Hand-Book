...
### Chapter Goal
এই চ্যাপ্টারের মূল লক্ষ্য হলো লার্জ Language Model-এর Input Data লেয়ারের মাইক্রোস্কোপিক Mechanism ডিকোড করা। আমরা খুব Practicalভাবে জানবো কীভাবে র টেক্সট ভেঙে Tokenে (Tokens) convertিত হয়, বাইট পেয়ার এনকোডিং (Byte Pair Encoding - BPE) কীভাবে নতুন শব্দ হ্যান্ডেল করে, Token কীভাবে হাই-ডাইমেনশনাল Embeddings (Embeddings) Vector-এ রূপ নিয়ে geometric অর্থ প্রকাশ করে এবং AI-এর র্যান্ডম মেমরি মানে Context Window (Context Window) কীভাবে কাজ করে।

### Why Should I Care?
Developer হিসেবে Prompt ইনজেকশন ব্লক করতে, Custom আরএজি (RAG) পাইপলাইন ডিজাইন করতে এবং API কস্টিং অপ্টিমাইজ করতে Tokenizer ও Embeddingsের জ্ঞান থাকা অক্সিজেন নেওয়ার মতোই জরুরি। তুমি যদি না জানো কেন একটি বাংলা শব্দ ৩ থেকে ৫ গুণ বেশি Token কনজিউম করে এবং কীভাবে Embeddings Vector-এর geometric অ্যালাইনমেন্ট কাজ করে, তবে তুমি প্রোডাকশনে saveী ও perfect AI System দাঁড় করাতে পারবে না।

### Big Picture
আমরা আগের চ্যাপ্টারে সেলফ-Attention-এর মাধ্যমে Transformerের ভেতরের সম্পর্ক খোঁজার লজিক শিখেছি। এই চ্যাপ্টারে আমরা দেখবো Model-এর Input হিসেবে টেক্সট ঢোকার ঠিক পূর্ব মুহূর্তে কীভাবে Data প্রিপারেশন লেয়ার কাজ করে। এটি আমাদের **Part 4 — Modern AI Foundations** এর শেষ তাত্ত্বিক চ্যাপ্টার।
