...
তুমি কি কখনো ভেবেছো — ChatGPT বা Gemini যতই শক্তিশালী হোক না কেন, তারা কিন্তু তোমার কোম্পানির ইন্টারনাল পলিসি, কোনো কাস্টমারের লাইভ ট্রানজ্যাকশন হিস্টোরি কিংবা আজ সকালের কোনো লেটেস্ট সিক্রেট আপডেট জানে না? আর এই নতুন তথ্যগুলো শেখানোর জন্য প্রতিবার কোটি টাকা খরচ করে মডেল ফাইন-টিউনিং (Fine-Tuning) করাও অসম্ভব। এখানেই জন্ম আরএজি বা Retrieval-Augmented Generation (RAG)-এর।

तो চলো এই চ্যাপ্টারে AI দুনিয়ার সবচেয়ে জনপ্রিয় আর দরকারি মেথড RAG-এর মূল মেকানিজমটা একদম ক্র্যাক করে ফেলি। আমরা দেখবো কীভাবে আরএজি-র ইনজেস্ট (Ingestion), রিট্রিভাল (Retrieval) আর জেনারেশন (Generation) পাইপলাইনগুলো কাজ করে, আর কীভাবে recursive কিংবা semantic চাংকিং (Chunking) দিয়ে ডাটার অর্থ বজায় রেখে মডেলের ইনপুট তৈরি করা হয়। চলো পরীক্ষার হলে কোনো বই না নিয়ে বসা বনাম বই খুলে পরীক্ষা দেওয়ার এক দারুন গল্প দিয়ে শুরু করা যাক!
