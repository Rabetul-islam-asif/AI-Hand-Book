...
### Why Should I Care?
ChatGPT বা Gemini যতই শক্তিশালী হোক না কেন, তারা তোমার কোম্পানির ইন্টারনাল পলিসি, কাস্টমারের লাইভ ট্রানজ্যাকশন বা আজ সকালের কোনো সিক্রেট আপডেট জানে না। Model Fine-Tuning করা অত্যন্ত ব্যয়বহুল এবং সময়সাপেক্ষ। আরএজি হলো সবচেয়ে সস্তা, নিরাপদ এবং রিয়েল-টাইম মেথড যা মডেলকে তাৎক্ষণিকভাবে নতুন তথ্য শিখিয়ে কাজ করাতে পারে। আরএজি পাইপলাইন অপ্টিমাইজেশন না জানলে তুমি কখনই Enterprise-Grade এআই প্রডাক্ট আর্কিটেক্ট করতে পারবে না।
...
3. **Context Injection & Citation:** Prompt-এর ভেতর কড়া System রুল থাকে: `"Answer only using the context below and cite your sources [1], [2]..."`। এর ফলে এআই হ্যালুসিনেশনহীন নিখুঁত উত্তর ও সাইটেশন প্রডিউস করে।
...
* **Context Leakage:** একজন সাধারণ কাস্টমার চ্যাটবটে এমন প্রশ্ন করল যা কোম্পানির ইন্টারনাল এআই হ্যাক করে কোনো অ্যাডমিনের স্যালারি শিট বা সিক্রেট Project-এর Vector রিট্রাইভ করে প্রম্পটে ইনজেক্ট করে ফেলল।
...
* **Output:** বেস্ট ম্যাচ ডক রিট্রিভ করে জেনারেট হওয়া ফাইনাল এআই ইনজেকশন Prompt।
