...
### Chapter Goal
এই চ্যাপ্টারের মূল লক্ষ্য হলো এলএলএম-এর জেনারেটিভ ক্ষমতার সাথে কাস্টম নলেজ বেসের মেলবন্ধন ঘটানোর পাইপলাইন—অর্থাৎ আরএজি (RAG - Retrieval-Augmented Generation) এর কোর মেকানিজম নিখুঁতভাবে বোঝা। আপনি জানতে পারবেন কীভাবে আরএজি-র ইনজেস্ট (Ingestion), রিট্রিভাল (Retrieval), এবং জেনারেশন (Generation) পাইপলাইন কাজ করে এবং বিভিন্ন প্রকার চাংকিং স্ট্র্যাটেজি (Chunking - Character, Token, Recursive, Semantic) এর প্র্যাক্টিক্যাল প্রয়োগ ও প্রোডাকশন প্রজেক্টে এগুলোর নিখুঁত সিলেকশন ক্রাইটেরিয়া আয়ত্ত করতে পারবেন।

### Why Should I Care?
চ্যাটজিপিটি বা জেমিনি যতই শক্তিশালী হোক না কেন, তারা আপনার কোম্পানির ইন্টারনাল পলিসি, কাস্টমারের লাইভ ট্রানজ্যাকশন বা আজ সকালের কোনো সিক্রেট আপডেট জানে না। মডেল ফাইন-টিউনিং করা অত্যন্ত ব্যয়বহুল এবং সময়সাপেক্ষ। আরএজি হলো সবচেয়ে সস্তা, নিরাপদ এবং রিয়েল-টাইম মেথড যা মডেলকে তাৎক্ষণিকভাবে নতুন তথ্য শিখিয়ে কাজ করাতে পারে। আরএজি পাইপলাইন অপ্টিমাইজেশন না জানলে আপনি কখনই এন্টারপ্রাইজ-গ্রেড এআই প্রডাক্ট আর্কিটেক্ট করতে পারবেন না।
...
কল্পনা করুন, আপনি একটি অত্যন্ত কঠিন ফাইনাল পরীক্ষা দিতে বসেছেন। 
* **Closed-Book Exam (ফাইন-টিউনিং বা বেস মডেল):** আপনাকে পরীক্ষার হলে কোনো বই বা খাতা নিতে দেওয়া হলো না। আপনাকে আপনার মস্তিষ্কে সেভ থাকা পুরনো মুখস্থ নলেজ (Trained Weights) ব্যবহার করে সব কঠিন প্রশ্নের উত্তর লিখতে হবে। প্রশ্ন যদি আপনার সিলেবাসের বাইরে আসে, তবে আপনি বানিয়ে ভুল উত্তর (Hallucination) লিখবেন।
...
* **Open-Book Exam (RAG):** শিক্ষক আপনাকে পরীক্ষার হলে সম্পূর্ণ বুক এবং কোম্পানির পলিসি ফাইল সাথে নিয়ে বসার অনুমতি দিলেন (Open-Book Exam)। আপনার কাজ হলো প্রশ্নটি পড়ে প্রথমে বইয়ের সূচিপত্র ঘেঁটে সঠিক চ্যাপ্টার ও প্যারাগ্রাফটি খুঁজে বের করা (Retrieval), তারপর সেই পৃষ্ঠাটি চোখের সামনে খোলা রেখে নিখুঁত ও সত্যবাদী উত্তর খসড়া করা (Generation)। 
...
আরএজি-র সাফল্যের ৮০% নির্ভর করে আপনি কীভাবে ডেটা খণ্ড বা চাঙ্ক করছেন তার ওপর:
...
চাংক করার সময় আমরা সর্বদা দুটি চাঙ্কের মাঝখানে কিছুটা ওভারল্যাপ (Overlap) রাখি। এর মেকানিজমটি নিচে ডায়াগ্রামের মাধ্যমে ভিজ্যুয়ালাইজ করুন:
...
2. **Cosine Retrieval:** আপনার কুয়্যারির সাথে যে চাঙ্কগুলোর মিল ৯০%-এর বেশি, সেগুলো ছেঁকে নিয়ে প্রম্পটে সাজায়।
...
# ২. Recursive Text Splitter ইনিশিয়ালাইজ করুন
...
চলুন পাইথনে কাস্টম NumPy ব্যবহার করে কোনো এমএল ফ্রেমওয়ার্ক ছাড়া একটি পূর্ণাঙ্গ মিনি আরএজি রিট্রিভাল ও ইনফারেন্স কনটেক্সট ইনজেক্টর সিস্টেম আর্কিটেক্ট করি।
